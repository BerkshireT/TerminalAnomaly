  ...
  data () {
    return {
      ...
      imagesPhotos: [
        ...
        { expanded: false, info: 'dan v2, wadsworth, ohio', full: 'https://github.com/BerkshireT/Assets/blob/main/photography/dan%20v2.jpg?raw=true', compressed: 'https://github.com/BerkshireT/Assets/blob/main/photography/compressed/dan-v2.jpg?raw=true' },
        { expanded: false, info: 'driftwood beach, jekyll island, georgia', full: 'https://github.com/BerkshireT/Assets/blob/main/photography/driftwood%20beach.jpg?raw=true', compressed: 'https://github.com/BerkshireT/Assets/blob/main/photography/compressed/driftwood-beach.jpg?raw=true' },
        ...
        { expanded: false, info: 'jekyll island, georgia', full: 'https://github.com/BerkshireT/Assets/blob/main/photography/jekyll%20island.jpg?raw=true', compressed: 'https://github.com/BerkshireT/Assets/blob/main/photography/compressed/jekyll-island.jpg?raw=true' },
        { expanded: false, info: 'rocky river reservation, north olmstead, ohio', full: 'https://github.com/BerkshireT/Assets/blob/main/photography/rocky%20river.jpg?raw=true', compressed: 'https://github.com/BerkshireT/Assets/blob/main/photography/compressed/rocky-river.jpg?raw=true' },
        { expanded: false, info: 'steve v2, wadsworth, ohio', full: 'https://github.com/BerkshireT/Assets/blob/main/photography/steve%20v2.jpg?raw=true', compressed: 'https://github.com/BerkshireT/Assets/blob/main/photography/compressed/steve-v2.jpg?raw=true' },
