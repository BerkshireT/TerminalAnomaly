        ...
        <v-flex v-for="pic in imgProp" :key="pic.title">
            <v-card>
                ...
                <v-card-title primary-title class="grey darken-4">
                    ...
                    <v-flex shrink>
                        <v-btn flat outline :color="themeProp + ' lighten-3'" right route :to="'/' + pic.route">
                            <h3 class="subhedaing">{{ pic.button }}</h3>
                        </v-btn>
                    </v-flex>
                </v-card-title>
            </v-card>
...
export default {
    props: {
        imgProp: {
            required: true,
            default: [
                { image: 'comingsoon.jpg', title: 'Home', button: 'Home', route: '' }
            ]
        },
        layoutProp: {
            required: true,
        ...
        themeProp: {
            required: true,
            default: 'teal--text text--lighten-3'
        }
    }
}
</script>